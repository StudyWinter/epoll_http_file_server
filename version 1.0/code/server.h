/*************************************************************************
  > File Name: server.h
  > Author: Winter
  > Created Time: 2022年03月13日 星期日 10时05分14秒
 ************************************************************************/
...
void send_respond(int cfd, int no, char* disp, char* type, long len); // 发生头响应给浏览器
...
void disconnect(int cfd, int epfd);                                   // 封装一个断开连接的函数
